...
$db_user = "u737457905_lms";   // VERIFY THIS USERNAME EXACTLY IN HOSTRINGER
$db_pass = "i8IlJg0[";      // VERIFY THIS PASSWORD EXACTLY IN HOSTRINGER (or set a new one)
$db_name = "u737457905_lms";   // VERIFY THIS DATABASE NAME EXACTLY IN HOSTRINGER
